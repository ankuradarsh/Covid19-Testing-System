...
<head>
    ...
    <title>Covid-19 Testing System | New User Testing</title>
...
<form name="newtesting" method="post">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold" style="color: rgb(175, 0, 255);">Personal Information</h6>
                                </div>
                                <div class="card-body">
 ...
 <div class="form-group">
                        ...
                        <div class="col-lg-12">
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold" style="color: rgb(175, 0, 255);">Testing Information</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
