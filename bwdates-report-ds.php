        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center">B/w Dates Report Date Selection</h1>
...
<form method="post" action="bwdates-report-result.php">
  <div class="row">
                       ...
                       <div class="form-group">
                                            ...
                                            <input type="date" class="form-control mb-4" id="fromdate" name="fromdate" required="true">
                                        </div>
