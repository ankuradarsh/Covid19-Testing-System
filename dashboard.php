                            ...
                            <div class="card border-left-primary shadow h-100 py-4">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-virus fa-3x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-xl-8 col-md-8 mb-4">
                            <div class="card border-left-info shadow h-100 py-4">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-lg font-weight-bold text-info text-uppercase mb-1"> On the way for sample collection
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-motorcycle fa-3x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class="card border-left-warning shadow h-100 py-4">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-prescription-bottle fa-3x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                                </a>
                        ...
                        <div class="col-xl-8 col-md-8 mb-4">
                            <div class="card border-left-info shadow h-100 py-4">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-lg font-weight-bold text-info text-uppercase mb-1">Report Delivered
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
