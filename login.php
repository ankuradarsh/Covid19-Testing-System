    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <h3 align="center" style="margin-top:4%;color:#fff">Covid-19 Testing System</h3>
                    ...
                    <div class="card-body p-0">
                        ...
                        <form name="login" method="post">
                            <div class="row">
                                ...
                                <img src="images/stay-safe.jpg" class="col-lg-7" alt="">
                                <div class="col-lg-5">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h3 text-gray-1000 mb-4">Welcome Back!</h1>
                                        </div>
                                        <div class="text-center">
                                            <p class="mb-4" style="color: rgb(175, 0, 255); font-size:smaller;">this panel is only for admins.</p>
                                        </div>
                                        <form class="user">
